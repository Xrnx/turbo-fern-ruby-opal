...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DDcDuP5i.mjs");
...
var manifest = { "548d4980325f5a1a0b324d3beb3f5a4bb853165c918fa00b8dcf728aa82f6023": {
	functionName: "getArrivals_createServerFn_handler",
	importer: () => import("./arrivals-DASPgvRL.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D8T0GqIP.mjs").then((n) => n.t),
