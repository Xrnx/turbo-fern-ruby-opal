...
//#region node_modules/.nitro/vite/services/ssr/assets/router-D8T0GqIP.js
...
var styles_default = "/assets/styles-L8LWFLEc.css";
var APP_NAME = "Halt";
var Route$2 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Singapore bus arrivals in one tap. Enter a 5-digit stop code and see every incoming bus."
			},
			{
				name: "theme-color",
				content: "#09090b"
...
var $$splitComponentImporter$1 = () => import("./routes-2xi_m407.mjs");
var Route$1 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./stop._code-SyIHmuLq.mjs");
var Route = createFileRoute("/stop/$code")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
